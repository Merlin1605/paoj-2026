...
public final class AuditService {
    ...
    // Asigură siguranța la lucrul cu mai multe fire de execuție
    ...
    public void log(String actionName) {
        lock.lock(); // Preia controlul exclusiv
        // FileWriter(..., true) înseamnă modul APPEND (nu șterge ce era înainte)
        try (PrintWriter pw = new PrintWriter(new FileWriter(AUDIT_FILE, true))) {
            ...
            lock.unlock(); // Eliberează controlul garantat, chiar și în caz de excepție
        }
    }
}